...
public static class SlashCommandCatalog
{
    public static IReadOnlyList<SlashCommandInfo> All { get; } = new[]
    {
        ...
        new SlashCommandInfo("/doctor", "report terminal capabilities and the active configuration"),
        new SlashCommandInfo("/config", "print the effective settings (secrets redacted)"),
